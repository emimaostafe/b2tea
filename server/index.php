...
require_once('php/validateURL.php');
     ...
     if ($_SERVER['REQUEST_URI'] === '/api/products') {
        ...
        // $contoller = new ProductsController($dbConnection, )
         ...
         echo json_encode($products);
          ...
          $products = [
             ['id' => 11, 'imageUrl' => 'https://i.ibb.co/xmc453j/nu-ma-uita.jpg', 'name' => 'Forget Me Not', 'rating' => 4.3, 'description' => 'A delicate herbal tea with a subtle floral flavor, made from the blue blossoms of the forget-me-not plant.'],
             ...
             ['id' => 14, 'imageUrl' => 'https://i.ibb.co/FxcLkkZ/travel-lover.jpg', 'name' => 'Travel Lover', 'rating' => 4.6, 'description' => 'A rustic, mysterious blend of spices and herbs, with a hint of mint and forest fruis notes, to awaken your senses and inspire your travels.']
         ];
